<div id="technology" class="w-full md:w-1/2 xl:w-1/3 px-4">
    <div class="rounded-lg">
        ...
        {{-- Container --}}
        <div class="p-4 text-left bg-gradient-to-b from-white to-blue-100">

            {{-- Title --}}
            <h3 class="text-blue-900 font-bold text-2xl">Trabaja de programador</h3>

            {{-- Description --}}
            <h4 class="my-4 p-2 text-sm text-gray-700 leading-relaxed border-l-8 italic border-blue-200 pl-4">
            ...
            <div class="flex p-2 text-sm">
                <ul class="w-full xl:w-1/3">
                    ...
                    @foreach($languages as $language)
                        <li class="w-full text-left inline-block my-1">
                            <a href="{{ rute_to_language(collect(['name' => to_slug($language->name), 'id' => $language->id ])) }}" class="border-b border-dotted border-blue-500 text-blue-800 hover:text-orange-700 font-bold">{{ $language->name }}</a>
                        </li>
